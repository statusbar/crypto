...
- **Per-message size.** Strictly bounded at 2³⁶ − 32 bytes per RFC 8452 §6. The implementation does not currently reject inputs above this bound at the entry point — callers responsible for any application-level cap.
